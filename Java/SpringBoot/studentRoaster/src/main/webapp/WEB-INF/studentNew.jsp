...
<div class="container d-flex align-items-center flex-column p-5">
    <h1>New Student</h1>
    <form:form action="/students/new" method="post" modelAttribute="student" class="d-flex flex-column align-items-start">
        <div class="row m-1">
        ...
        <div class="row m-1">
            <form:input path="age" type="number"  min="18" max="99" placeholder="Age" class="form-control col-5" required="required" value="x"/>
        </div>
